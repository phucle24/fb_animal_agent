...
systemctl disable --now fb-animal-agent-publish-morning.timer 2>/dev/null || true
systemctl disable --now fb-animal-agent-publish-afternoon.timer 2>/dev/null || true
