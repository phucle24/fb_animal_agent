...
DONATE_COMMENT_TEMPLATES = (
    ...
    "Tiếp năng lượng cho team editor mua mì gói chạy deadline video tiếp theo ở đây nha:\n👉 {url}",
    "Mời admin ly trà đá, góp một chút động lực để kênh ra thêm nhiều video về các 'báo thủ' tự nhiên nha:\n👉 {url}",
    "Kinh phí tài trợ hạt dưa cho sóc, cá hồi cho gấu và cà phê cho admin thức đêm dịch bài nằm ở đây nè:\n👉 {url}",
    "Xem xong thấy xả stress thì ghé 'góp một chút' nuôi kênh nha cả nhà, admin hứa chăm ra video bổ mắt hơn nữa:\n👉 {url}",
    "Chiếc link 'Góp một chút' siêu lành tính, không cắn đâu, bấm vào chỉ làm admin vui tít mắt cả ngày thôi:\n👉 {url}",
    "Góp một chút mua cà phê nạp 'mana' cho admin tiếp tục mổ xẻ thế giới muôn loài:\n👉 {url}",
    "Kênh phi lợi nhuận nhưng đam mê thì vô tận! Đi ngang quý mến team thì gửi một chút yêu thương ở đây nha:\n👉 {url}",
    "Một lượt 'góp một chút' là một ngày admin bớt ăn mì tôm chay để săn lùng tư liệu động vật quý hiếm:\n👉 {url}",
    "Trạm tiếp tế năng lượng khẩn cấp cho admin sau những đêm dài vật lộn cùng deadline:\n👉 {url}",
    "Đường hầm bí mật dẫn vào quỹ bảo tồn nụ cười của admin, rảnh tay thì ghé chơi nha:\n👉 {url}",
    "Thích cách kể chuyện của page thì mời admin cốc nước mát ở đây nhé, cảm ơn cả nhà nhiều:\n👉 {url}",
    "Quỹ hỗ trợ editor không bị 'tiền đình' khi soi từng khung hình động vật hoang dã:\n👉 {url}",
    "Góc chill của admin sau mỗi lần dựng video, để đây cho ai muốn tiếp sức nè:\n👉 {url}",
)
