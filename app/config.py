...
REEL_PRODUCT_COMMENTS_PER_POST = int(
    os.getenv("ANIMAL_AGENT_REEL_PRODUCT_COMMENTS_PER_POST", str(PRODUCT_COMMENTS_PER_POST))
)
DONATE_COMMENT_URL = os.getenv("ANIMAL_AGENT_DONATE_COMMENT_URL", "").strip()
DONATE_COMMENT_DELAY_MINUTES = int(os.getenv("ANIMAL_AGENT_DONATE_COMMENT_DELAY_MINUTES", "15"))
DONATE_COMMENT_SCAN_LIMIT = int(os.getenv("ANIMAL_AGENT_DONATE_COMMENT_SCAN_LIMIT", "25"))
DONATE_COMMENT_LOOKBACK_HOURS = int(os.getenv("ANIMAL_AGENT_DONATE_COMMENT_LOOKBACK_HOURS", "72"))
